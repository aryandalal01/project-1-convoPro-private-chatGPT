...
def create_new_conversation(title:Optional[str] = None,role:Optional[str] = None,content:Optional[str] = None)->str:
    ...
    if role and content:
        doc["message"].append({"role":role,"content":content,"ts":ts})
...
def get_all_converations()->Dict[str,str]:
